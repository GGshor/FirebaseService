...
--]]
--== Configuration;
local defaultDatabase = "https://example.firebaseio.com/"; -- Set your database link
local authenticationToken = "tHiSIsAFakeAuTHEntiCAtiONToKEN"; -- Authentication Token
